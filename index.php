                ...
                <nav class="header__navbar">
                    ...
                    <ul class="header__navbar-list">
                        ...
                        <li class="header__navbar-items header-navbar-user">
                            ...
                            <span class="header-navbar-user-name" style="color:antiquewhite">Nguyễn Minh Ân</span>
                ...
                <div class="header__with-search">
                    ...
                    <div class="header__menu">
                        <ul class="header__menu-list">
                            ...
                            <li class="header__menu-items">
                                <a href="quanly.php" style="text-decoration: none;color:white" class="header__menu-items-link">Quản lý</a>
                            </li>
                            <li class="header__menu-items">
                                <a href="index.php" style="text-decoration: none;color:white" class="header__menu-items-link">Sản phẩm</a>
                            </li>
                        </ul>
                    </div>
                    <!-- Search History -->
                    ...
                    <div class="col l-10 m-12 c-12">
                        <!-- <div class="home-filter hide-on-mobile-tablet">
                            <form action="#" method="get">
                                ...
                                <input type="submit" class="home-filter__btn btn" name="viewprod" value="Phổ biến">
                                <input type="submit" class="home-filter__btn btn btn--primary" name="createprod" value="Mới nhất">
                            ...
                            <!-- <div class="row sm-gutters"> -->
                                ...
                                <!-- <a href="#" class="home-product-items"> -->
                                    <?php
                                        ...
                                        //     $p=new ViewProduct();
                                        //     $search=$p->face_Search();
                                        // }
                                        if(isset($_REQUEST["search"])){
                                            $p=new ViewProduct();
                                            $search1=$p->face_SearchPricemin200();
                                        }
                                        // else if(isset($_REQUEST["viewprod"])){
                                        //     $p=new ViewProduct();
                                        //     $view=$p->ViewProduct();
                                        // }
                                        // else if(isset($_REQUEST["createprod"])){
                                        //     $p=new ViewProduct();
                                        //     $create=$p->CreateProduct();
                                        // }
                                        // else if(isset($_REQUEST["min_price"])&&isset($_REQUEST["max_price"])){
                                        //     $p=new ViewProduct();
                                        //     $searchbyPrice=$p->face_SearchbyPrice();
                                        // }
                                        // else if(isset($_REQUEST["price"])){
                                        //     $p=new ViewProduct();
                                        //     $search100min=$p->face_SearchPricemin100();
                                        // }
                                        else{

                                            $p=new ViewProduct();
                                            $result=$p->face_Product();
        ...
        <footer class="footer">
            <div class="grid wide footer__content">
                ...
                <!-- <div class="row">
                    ...
                    <div class="footer__regeter">
                        <ul class="footer__regeter-list">
                            <li class="footer__regeter-items">
                                <a href="" class="footer__regeter-img"></a>
                            </li>
                        </ul>
                    </div>
                </div> -->
